      ...
      {showScore ? (
        <div className="score-board">
         <h2 >
         {
           ...
           {score < 67 ? <><h2 style={{color:"red"}}> You lose ! <br /> The Score is  {score}</h2> <br /> Progress:<progress value={score}  max={100} ></progress>  </> : <><h2 style={{color:"green"}}>  Congratulations.. <br />  Your score is {score} </h2>  <br />Progress: <progress value={score}  max={100}> </progress> </>} 
            </h2>
        </div>
      ) : (
        <div className='main'>
